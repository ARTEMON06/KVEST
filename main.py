...
Мы наконец-то выбрались на отдых, тяжелые будни нас очень утомили. Томми уже ,ыл готов жарить шашлыки и ставить палатку,
...
посреди дня еще и в лесу. Что делать? Как мне быть?""",
    'step_1': """Я подбегаю к озеру, где должны были купаться Кэтрин и Поли. Мне нужно их защитить...
...
службу безопасности\". Кэт лишь кивнула. \"И возможно нам стоит пожить некоторое время вместе. Неделю или две. 
Пока все более-менее не устаканиться. Не хочу оставлять тебя одну.\" """
}


def pprint(text_to_print):
    if not DEBUG:
